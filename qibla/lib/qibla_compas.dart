...
class QiblaCompas extends StatefulWidget {
  const QiblaCompas({super.key});

  @override
  State<QiblaCompas> createState() => _QiblaCompasState();
}

class _QiblaCompasState extends State<QiblaCompas> {
