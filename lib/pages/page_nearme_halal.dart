...
class NearmeHalalPage extends StatefulWidget {
  @override
  _NearmeHalalPageState createState() => _NearmeHalalPageState();
}
...
class _NearmeHalalPageState extends State<NearmeHalalPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _buildListHalal(),
    );
  }

  Widget _buildListHalal() {
    return BlocProvider(
      create: (context) => nearmeHalalBloc,
      child: BlocListener<NearmeHalalBloc, NearmeHalalState>(
        listener: (context, state) {
          if (state is NearmeHalalError) {
            return showFloatingFlushbar(state.message);
          }
        },
        child: BlocBuilder<NearmeHalalBloc, NearmeHalalState>(
          builder: (context, state) {
            if (state is NearmeHalalInitial) {
              return LoadingIndicator();
            } else if (state is NearmeHalalLoading) {
              return LoadingIndicator();
            } else if (state is NearmeHalalLoaded) {
              return _buildList(context, state.nearmeHalalModel);
            } else if (state is NearmeHalalError) {
              return Padding(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Oops Terjadi kesalahan, Lokasi tidak ditemukan, coba beberapa saat lagi",
