  ...
  factory NearmeMosqueModel.fromJson(Map<String, dynamic> json) =>
      NearmeMosqueModel(
        ...
        response: json["response"] == null
            ? null
            : ResponseNearmeMosque.fromJson(json["response"]),
      );
...
class Flags {
  ...
  factory Flags.fromJson(Map<String, dynamic> json) => Flags(
        outsideRadius:
            json["outsideRadius"] == null ? null : json["outsideRadius"],
      );

  Map<String, dynamic> toJson() => {
        "outsideRadius": outsideRadius == null ? null : outsideRadius,
      };
}
...
class Category {
  ...
  factory Category.fromJson(Map<String, dynamic> json) => Category(
        ...
        icon: json["icon"] == null ? null : IconCategory.fromJson(json["icon"]),
